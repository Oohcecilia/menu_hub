...
const translations = {
  en: {
    ...
    placeOrder: "Generate QR Code", placing: "Placing...", orderPlaced: "Order Placed!",
    orderSuccess: "Your order has been placed successfully", orderNumber: "Order Number",
    orderSummary: "Order Summary", scanQR: "Show this QR code to the waiter.",
  ...
  es: {
    ...
    placeOrder: "Generar código QR", placing: "Procesando...", orderPlaced: "¡Pedido Realizado!",
    orderSuccess: "Tu pedido ha sido realizado exitosamente", orderNumber: "Número de Pedido",
    orderSummary: "Resumen del Pedido", scanQR: "Muestre este código QR al camarero.",
  ...
  de: {
    ...
    placeOrder: "QR-Code generieren", placing: "Wird bearbeitet...", orderPlaced: "Bestellung aufgegeben!",
    orderSuccess: "Ihre Bestellung wurde erfolgreich aufgegeben", orderNumber: "Bestellnummer",
    orderSummary: "Bestellübersicht", scanQR: "Zeigen Sie diesen QR-Code dem Kellner.",
  ...
  fr: {
    ...
    placeOrder: "Générer un code QR", placing: "En cours...", orderPlaced: "Commande passée!",
    orderSuccess: "Votre commande a été passée avec succès", orderNumber: "Numéro de commande",
    orderSummary: "Récapitulatif", scanQR: "Montrez ce code QR au serveur",
  ...
  it: {
    ...
    placeOrder: "Genera codice QR", placing: "Elaborando...", orderPlaced: "Ordine inviato!",
    orderSuccess: "Il tuo ordine è stato inviato con successo", orderNumber: "Numero ordine",
    orderSummary: "Riepilogo ordine", scanQR: "Mostra questo codice QR al cameriere",
  ...
  zh: {
    ...
    placeOrder: "生成二维码", placing: "处理中...", orderPlaced: "订单已下！",
    orderSuccess: "您的订单已成功提交", orderNumber: "订单号",
    orderSummary: "订单摘要", scanQR: "向服务员出示此二维码",
  ...
  ja: {
    ...
    placeOrder: "QRコードを生成", placing: "処理中...", orderPlaced: "注文完了！",
    orderSuccess: "ご注文が正常に完了しました", orderNumber: "注文番号",
    orderSummary: "注文内容", scanQR: "このQRコードを店員に見せてください",
  ...
  ko: {
    ...
    placeOrder: "QR 코드 생성", placing: "처리 중...", orderPlaced: "주문 완료!",
    orderSuccess: "주문이 성공적으로 완료되었습니다", orderNumber: "주문 번호",
    orderSummary: "주문 요약", scanQR: "이 QR 코드를 직원에게 보여주세요",
  ...
  ru: {
    ...
    placeOrder: "Сгенерировать QR-код", placing: "Обработка...", orderPlaced: "Заказ размещён!",
    orderSuccess: "Ваш заказ успешно размещён", orderNumber: "Номер заказа",
    orderSummary: "Сводка заказа", scanQR: "Покажите этот QR-код официанту",
  ...
  fil: {
    ...
    placeOrder: "Bumuo ng QR Code", placing: "Nagpo-proseso...", orderPlaced: "Nai-order na!",
    orderSuccess: "Matagumpay na nailagay ang iyong order", orderNumber: "Numero ng Order",
    orderSummary: "Buod ng Order", scanQR: "Ipakita ang QR code na ito sa waiter.",
