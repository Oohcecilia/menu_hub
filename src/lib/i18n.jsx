...
const translations = {
  en: {
    ...
    addToCart: "Add to Cart", added: "Added!", cart: "Cart", yourCart: "Your Cart",
  ...
  es: {
    ...
    addToCart: "Agregar", added: "¡Agregado!", cart: "Carrito", yourCart: "Tu Carrito",
    ...
    searchMenu: "Buscar platillos...", noResults: "No se encontraron artículos", viewOrder: "Ver Pedido",
  ...
  de: {
    ...
    addToCart: "Hinzufügen", added: "Hinzugefügt!", cart: "Warenkorb", yourCart: "Ihr Warenkorb",
    ...
    searchMenu: "Gerichte suchen...", noResults: "Keine Artikel gefunden", viewOrder: "Bestellung ansehen",
  ...
  fr: {
    ...
    addToCart: "Ajouter", added: "Ajouté!", cart: "Panier", yourCart: "Votre Panier",
    ...
    searchMenu: "Rechercher des plats...", noResults: "Aucun article trouvé", viewOrder: "Voir la commande",
  ...
  it: {
    ...
    addToCart: "Aggiungi", added: "Aggiunto!", cart: "Carrello", yourCart: "Il tuo Carrello",
    ...
    searchMenu: "Cerca piatti...", noResults: "Nessun articolo trovato", viewOrder: "Vedi ordine",
  ...
  zh: {
    ...
    addToCart: "加入购物车", added: "已添加!", cart: "购物车", yourCart: "我的购物车",
    ...
    searchMenu: "搜索菜品...", noResults: "未找到菜品", viewOrder: "查看订单",
  ...
  ja: {
    ...
    addToCart: "追加", added: "追加済み!", cart: "カート", yourCart: "カート",
    ...
    searchMenu: "料理を検索...", noResults: "料理が見つかりません", viewOrder: "注文を見る",
  ...
  ko: {
    ...
    addToCart: "추가", added: "추가됨!", cart: "장바구니", yourCart: "장바구니",
    ...
    searchMenu: "메뉴 검색...", noResults: "항목을 찾을 수 없습니다", viewOrder: "주문 보기",
  ...
  ru: {
    ...
    addToCart: "Добавить", added: "Добавлено!", cart: "Корзина", yourCart: "Ваша корзина",
    ...
    searchMenu: "Поиск блюд...", noResults: "Ничего не найдено", viewOrder: "Смотреть заказ",
  ...
  fil: {
    ...
    addToCart: "Idagdag", added: "Naidagdag!", cart: "Cart", yourCart: "Iyong Cart",
    ...
    searchMenu: "Maghanap sa menu...", noResults: "Walang nahanap", viewOrder: "Tingnan ang Order",
