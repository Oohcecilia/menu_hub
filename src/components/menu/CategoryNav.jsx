          ...
          {items.map(item => {
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors duration-300 capitalize touch-manipulation
                ${isActive
