      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="h-8 w-8 rounded-full bg-card border border-primary/30 shadow-md flex items-center justify-center text-muted-foreground hover:text-foreground hover:shadow-lg transition-all"
          >
